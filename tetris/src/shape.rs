...
macro_rules! impl_shape_constructor {
    ($( $new:ident $typ:literal: [ $( $pos:expr ),* ] anchored @ $anchor:expr; )*) => {
        $(
            pub fn $new() -> Self {
                Self {
                    typ: $typ,
...
impl Shape {
    impl_shape_constructor! {
        new_i "🟦": [Pos(0, 0), Pos(1, 0), Pos(2, 0), Pos(3, 0)] anchored @ Pos(1, 0);
        new_o "🟨": [Pos(0, 0), Pos(1, 0), Pos(0, 1), Pos(1, 1)] anchored @ Pos(0, 0);
        new_t "🟫": [Pos(0, 0), Pos(1, 0), Pos(2, 0), Pos(1, 1)] anchored @ Pos(1, 0);
        new_j "🟪": [Pos(0, 0), Pos(0, 1), Pos(0, 2), Pos(1, 2)] anchored @ Pos(0, 1);
        new_l "🟧": [Pos(0, 0), Pos(0, 1), Pos(0, 2), Pos(-1, 2)] anchored @ Pos(0, 1);
        new_s "🟩": [Pos(0, 0), Pos(-1, 0), Pos(0, 1), Pos(1, 1)] anchored @ Pos(0, 0);
        new_z "🟥": [Pos(0, 0), Pos(1, 0), Pos(0, 1), Pos(-1, 1)] anchored @ Pos(0, 0);
    }
    ...
    pub fn collide_with(&self, other: &Shape) -> bool {
